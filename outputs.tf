output "cosmosdb_sql_stored_procedures_id" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.id }
}
output "cosmosdb_sql_stored_procedures_account_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.account_name }
}
output "cosmosdb_sql_stored_procedures_body" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.body }
}
output "cosmosdb_sql_stored_procedures_container_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.container_name }
}
output "cosmosdb_sql_stored_procedures_database_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.database_name }
}
output "cosmosdb_sql_stored_procedures_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.name }
}
output "cosmosdb_sql_stored_procedures_resource_group_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_sql_stored_procedure.cosmosdb_sql_stored_procedures : k => v.resource_group_name }
}
